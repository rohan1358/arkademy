  ...
  $i = 0;
   ...
   foreach ($result as $result) : $i++?>
    <tr>
      ...
      <td><a  data-toggle="modal" data-target="#edit<?php echo $i; ?>" href="">Edit</a>|<a href="delete.php?id=<?php echo $result['id']; ?>">Delete</a></td>
    </tr>
      ...
      <div class="modal-header">
        ...
        <form action="edit.php?id=<?php echo $id ?>" method="post">
          ...
          <select class="form-control">
            <option name='casier'><?php echo $result['casier']; ?></option>
          </select>
          <select class="form-control">
            <option name='produk'><?php echo $result['produk']?></option>
          </select>
          <input class="form-control" name="kategori" type="text" placeholder="Default input" value="<?php echo $result['kategori']?>" >
          <input class="form-control" name="harga" type="text" placeholder="Default input" value="<?php echo $result['harga']?>">
          <div align="right">
            <button type="button" data-targer='#edit<?php echo $i; ?>' class="btn btn-primary">Edit</button>
          </div>
        </div>
        </form>
